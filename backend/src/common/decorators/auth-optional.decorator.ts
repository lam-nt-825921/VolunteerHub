 ...
 * Nếu có token hợp lệ thì parse và set user, nếu không thì vẫn cho phép truy cập (user = null)
 * Sử dụng cùng với OptionalJwtAuthGuard
 */
export function AuthOptional() {
  return applyDecorators(
    SetMetadata(IS_AUTH_OPTIONAL_KEY, true),
